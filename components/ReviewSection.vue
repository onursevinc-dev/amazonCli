    ...
    <div class="reviewsMedley">
      <div class="row">
        <div class="col-lg-4 col-md-5 col-sm-12">
          ...
          <span class="a-color-base a-size-large">
          ...
          <div class="a-row">
            ...
            <span class="a-button-base writeReviewButton cm-cr-button-wide">
              <span class="a-button-inner">
                <nuxt-link :to="`/reviews/${this.$route.params.id}`" class="a-button-text" role="button">Write a customer review</nuxt-link>
              </span>
            </span>
          </div>
          <div class="clearfix">
        ...
        <div class="col-lg-6 col-md-7 col-sm-12">
          <div class="reviews-image-gallery">
            ...
            <div class="a-spacing-small a-spacing-top-small">
              <img class="img-fluid" width="12%" v-for="review in reviews" :key="review._id" :src="review.photo"/>
            </div>
<!--            <div>-->
          ...
          <div class="cr-widget-focalreviews">
            <div class="card-padding">
              ...
              <div class="review-body" v-for="review in reviews" :key="review._id">
                ...
                <span class="review-date">{{review.date.substr(0,10)}}</span>
