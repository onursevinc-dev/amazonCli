  ...
  <div>
    ...
    <form novalidate="novalidate" onsubmit="return false;" class="searchbox sbx-amazon">
      <div role="search" class="sbx-amazon__wrapper">
        <input  v-model="query" type="search" name="search" placeholder="Search your favorite product"
               autocomplete="off" required="required" class="sbx-amazon__input">
        <button @click="onSearch" type="submit" title="Submit your search query." class="sbx-amazon__submit">
